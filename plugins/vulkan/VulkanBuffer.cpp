...
void VulkanBuffer::Create(VkDevice device, VkPhysicalDevice physical,
                          ...
                          VkMemoryPropertyFlags properties)
{
    ...
    CheckVkResult(vkCreateBuffer(device, &bci, nullptr, &buffer),
    ...
    CheckVkResult(vkAllocateMemory(device, &ai, nullptr, &memory),
...
static void endOneShot(VkDevice dev, VkCommandPool pool, VkQueue q,
                       VkCommandBuffer cmd)
{
                          ...
                          VkCommandPool pool, VkQueue graphicsQ)
{
    ...
    if (memFlags & VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT) {
        ...
        if (!(memFlags & VK_MEMORY_PROPERTY_HOST_COHERENT_BIT)) {
            ...
            rng.memory = memory; rng.offset = 0; rng.size = size;
    ...
    staging.Create(deviceRef, physicalDeviceRef, size,
